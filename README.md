...
Frontend Integration Notes
	...
	•	Frontend can use generated_at for timestamps, headline for display, alerts and key_metrics for dashboard widgets, recent_changes for highlighting changes, open_decisions for actionable items, and last_interaction for call prep.
